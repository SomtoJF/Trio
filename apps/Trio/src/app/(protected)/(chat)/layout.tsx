...
import { Sidebar, SidebarBody, SidebarLink } from '@/shadcn/ui/sidebar';
import { PiNotePencilBold } from 'react-icons/pi';
import { cn } from '@/lib/utils';
import { useAuthStore } from '@trio/hooks';
import { NavDropdown } from '@trio/components';
import Link from 'next/link';
import { useQuery } from '@tanstack/react-query';
import { queryKeys } from '@trio/query-key-factory';
import { currentUserChats } from '@trio/services';
import { ChatType } from '@/libs/types/src';
